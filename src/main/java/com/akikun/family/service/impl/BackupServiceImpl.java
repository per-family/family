...
import static com.akikun.family.model.support.HaloConst.HALO_BACKUP_MARKDOWN_PREFIX;
import static com.akikun.family.model.support.HaloConst.HALO_BACKUP_PREFIX;
import static com.akikun.family.model.support.HaloConst.HALO_DATA_EXPORT_PREFIX;
import static com.akikun.family.utils.DateTimeUtils.HORIZONTAL_LINE_DATETIME_FORMATTER;
import static com.akikun.family.utils.FileUtils.checkDirectoryTraversal;
...
import com.akikun.family.handler.file.FileHandler;
import com.akikun.family.model.dto.BackupDTO;
...
import com.akikun.family.model.entity.ContentPatchLog;
...
import com.akikun.family.model.entity.PostTag;
...
import com.akikun.family.model.entity.ThemeSetting;
import com.akikun.family.model.entity.User;
import com.akikun.family.model.params.PostMarkdownParam;
import com.akikun.family.model.support.HaloConst;
import com.akikun.family.model.vo.PostMarkdownVO;
import com.akikun.family.security.service.OneTimeTokenService;
import com.akikun.family.service.AttachmentService;
...
import com.akikun.family.service.MenuService;
...
import com.akikun.family.service.ThemeSettingService;
import com.akikun.family.service.UserService;
import com.akikun.family.utils.DateTimeUtils;
import com.akikun.family.utils.DateUtils;
import com.akikun.family.utils.FileUtils;
import com.akikun.family.utils.FilenameUtils;
import com.akikun.family.utils.HaloUtils;
import com.akikun.family.utils.JsonUtils;
import com.akikun.family.utils.VersionUtil;
...
public class BackupServiceImpl implements BackupService {
    ...
    public BackupDTO backupWorkDirectory(List<String> options) {
        ...
        try {
            ...
            // Zip halo
            com.akikun.family.utils.FileUtils
    ...
    public BackupDTO exportMarkdowns(PostMarkdownParam postMarkdownParam) throws IOException {
        ...
        try (ZipOutputStream markdownZipOut = new ZipOutputStream(
            ...
            com.akikun.family.utils.FileUtils.zip(markdownFileTempPath, markdownZipOut);
            ...
            if (Files.exists(uploadPath)) {
                com.akikun.family.utils.FileUtils.zip(uploadPath, markdownZipOut);
            }

            // Remove files in the temporary directory
            com.akikun.family.utils.FileUtils.deleteFolder(markdownFileTempPath);
