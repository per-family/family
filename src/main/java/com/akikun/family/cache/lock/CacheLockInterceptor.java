package com.akikun.family.cache.lock;
...
import com.akikun.family.exception.FrequentAccessException;
...
public class CacheLockInterceptor {
    ...
    @Around("@annotation(com.akikun.family.cache.lock.CacheLock)")
